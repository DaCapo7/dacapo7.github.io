...
class project {
    ...
    calchtml() {
      if(this.lien != null){
          this.htmld = `<h2 style='text-align:center;font-size:40px;color:white;'>${this.title}</h2><br><p style='font-size:20px;color:white;'>${this.description}</p><hr><a target = '_blank' href='${this.lien}' style='font-size:20px;color:blue;text-decoration:underline'>Here is the project</a><p style='font-size:20px;color:gray;'>First release on: ${this.date}</p>`
...
[
    ...
    new project('Image to ascii converter', "My very first project: a image to ascii converter working with opencv in python. I had this idea by watching a video of <a href='https://www.youtube.com/channel/UCYnvxJ-PKiGXo_tYXpWAC-w' target='_blank'>Micode</a>, a french youtuber. Then I made a video to ascii converter based on the same principle.",'October 17, 2020', 'https://github.com/DaCapo7/ImgorVideo-to-ascii'),
...
window.addEventListener('load',()=>{
    ...
    for (i=0; i<projects.length; i++){
        ...
        point.style = "height:20px;width:20px;position:relative;background:rgb(80, 255, 246);box-shadow:0px 0px 10px rgb(80, 255, 246);transform:translateX(-7.5px);border-radius:100%;"
        ...
        if (i%2==0){acote.style = "background:rgb(30, 30, 30);width: 100px;height: 50px;position:relative;left:40px;z-index:100;top:-25px;font-size:10px;text-align:center;color:rgb(80, 255, 246);padding:3px 2px;box-shadow:0 0 10px rgb(80, 255, 246)"}
        else{acote.style = "background:rgb(30, 30, 30);width: 100px;height: 50px;position:relative;left:-125px;z-index:100;top:-25px;font-size:10px;text-align:center;color:rgb(80, 255, 246);padding:3px 2px;box-shadow:0 0 10px rgb(80, 255, 246)"}
